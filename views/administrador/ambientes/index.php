...
<body>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<button class='boton-inhabilitar'> <img src='../assets/inhabilitar.svg'></button>";
                            echo "</td>";   
                            echo "</tr>";
                        }
                    } else {
    ...
    <script>
        function redirectToUpdate(idAmbiente) {
            // Redirecciona al formulario de actualización con el ID del ambiente como parámetro en la URL
            window.location.href =  idAmbiente;
        }
    </script>
</body>
</html>
