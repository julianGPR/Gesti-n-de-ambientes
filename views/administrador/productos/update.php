        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <body>
                    ...
                    <div class="container">
                        <h1><i class="fas fa-box icon"></i> Actualizar Producto</h1>

                        <form id="actualizarProductoForm"
                            action="../actualizarProducto/<?php echo $producto['id_producto']; ?>" method="POST"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="fecha_creacion" id="fecha_creacion"
                                        value="<?= htmlspecialchars($producto['fecha_creacion']) ?>" required>
                                </div>
                            </div>
            ...
            <script>
                ...
                function submitForm() {
                    document.getElementById('actualizarProductoForm').submit();
                }
            </script>
